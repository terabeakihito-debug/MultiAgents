export const humanMutationActions = [
  ...
  "task-prepare-approval", "task-dependency-recovery-instructions", "task-approve", "task-approve-rework", "task-apply-review", "task-create-pr", "task-fetch-review", "task-refresh-pr",
