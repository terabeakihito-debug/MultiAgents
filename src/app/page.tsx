...
export default function Home() {
  ...
  return <main>
    ...
    </form></section> : task ? <TaskDetail task={task} tab={detailTab} onTab={setDetailTab} onDelete={deleteWorktree} onRun={() => void runFlow()} busy={sending || approvalProcessing || reviewProcessing} /> : null}
